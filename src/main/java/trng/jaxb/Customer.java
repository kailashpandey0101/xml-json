 ...
 *         &lt;element name="address" type="{http://www.kailash.org/CustomerSchema}Address"/&gt;
 *         &lt;element name="paymentMethod" type="{http://www.kailash.org/CustomerSchema}PaymentMethod" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
